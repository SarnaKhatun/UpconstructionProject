...
<!-- Mirrored from demo.themefisher.com/biztrox/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Mar 2022 08:07:30 GMT -->
<head>
    <meta charset="utf-8">
    <title>BIZTROX</title>
                        ...
                        <div class="col-md-7">
                            <div class="signup-form">
                                <form action="{{route('register')}}" method="post" >
                                    ...
                                    <div class="col-12">
                                        <input type="password" class="form-control" id="re-pass" name="password_confirmation" placeholder="Confirm Password">
                                    </div>
                                    <div class="col-sm-4">
...
<!-- Mirrored from demo.themefisher.com/biztrox/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Mar 2022 08:07:32 GMT -->
</html>
