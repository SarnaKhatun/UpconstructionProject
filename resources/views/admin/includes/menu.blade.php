        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('add-slider')}}">Add</a></li>
                        <li><a href="{{route('manage-slider')}}">Manage</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('blogCategories.create')}}">Add</a></li>
                        <li><a href="{{route('blogCategories.index')}}">Manage</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('serviceCategories.create')}}">Add</a></li>
                        <li><a href="{{route('serviceCategories.index')}}">Manage</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('projectCategories.create')}}">Add</a></li>
                        <li><a href="{{route('projectCategories.index')}}">Manage</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('blogs.create')}}">Add</a></li>
                        <li><a href="{{route('blogs.index')}}">Manage</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('services.create')}}">Add</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{route('projects.index')}}">Manage</a></li>
                    </ul>
                </li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('constructions.create')}}">Add</a></li>
                        <li><a href="{{route('constructions.index')}}">Manage</a></li>
                    </ul>
                </li>
